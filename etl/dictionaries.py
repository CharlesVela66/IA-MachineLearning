workclass_dict = {
    'Private': 1, 'Self-emp-not-inc': 2, 'Self-emp-inc': 3, 'Federal-gov': 4,
    'Local-gov': 5, 'State-gov': 6, 'Without-pay': 7, 'Never-worked': 8
}
marital_status_dict = {
    'Married-civ-spouse': 1, 'Divorced': 2, 'Never-married': 3, 'Separated': 4,
...
relationship_dict = {
    'Wife': 1, 'Own-child': 2, 'Husband': 3, 'Not-in-family': 4,
